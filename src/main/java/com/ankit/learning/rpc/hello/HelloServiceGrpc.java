package com.ankit.learning.rpc.hello;
...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc/hello.proto")
public final class HelloServiceGrpc {

  private HelloServiceGrpc() {}

  public static final String SERVICE_NAME = "org.baeldung.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.ankit.learning.rpc.hello.HelloRequest,
      com.ankit.learning.rpc.hello.HelloResponse> METHOD_HELLO =
      io.grpc.MethodDescriptor.<com.ankit.learning.rpc.hello.HelloRequest, com.ankit.learning.rpc.hello.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "org.baeldung.grpc.HelloService", "hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.ankit.learning.rpc.hello.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.ankit.learning.rpc.hello.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.ankit.learning.rpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.ankit.learning.rpc.hello.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.ankit.learning.rpc.hello.HelloRequest,
                com.ankit.learning.rpc.hello.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.ankit.learning.rpc.hello.HelloResponse hello(com.ankit.learning.rpc.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ankit.learning.rpc.hello.HelloResponse> hello(
        com.ankit.learning.rpc.hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.ankit.learning.rpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.ankit.learning.rpc.hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class HelloServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ankit.learning.rpc.hello.Hello.getDescriptor();
    }
  }
